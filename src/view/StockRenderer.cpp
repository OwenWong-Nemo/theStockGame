...
void StockRenderer::drawStockRow(sf::RenderWindow& window, const sf::Font& font, const Stock& stock, int index)
{
    ...
    if (stock.getIsPriceChanged()) {
        ...
        } else if (stock.getPriceChangePercentage() < 0) {
...
bool StockRenderer::isClicked(sf::Vector2f mousePos, int index)
{
